            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a class="btn btn-primary btn-xs" id="btnagregarLiderlist">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="tablaLiderlist" class="table table-striped table-bordered table-hover dataTables-example tablaDatos" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
