            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a class="btn btn-primary btn-xs" id="btnagregarDispositivo">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="tablaDispositivos" class="table table-striped table-bordered table-hover dataTables-example tablaDatos" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>{{trans('tabla.codigo')}}</th>
                                    <th>{{trans('tabla.nombre')}}</th>
                                    <th>{{trans('tabla.ip')}}</th>
                                    <th>{{trans('tabla.puerto')}}</th>
                                    <th>{{trans('tabla.modelo')}}</th>
                                    <th>{{trans('tabla.proveedor')}}</th>
                                    <th>{{trans('tabla.firmware')}}</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa-solid fa-usb-drive"></i> Dispositivos</h4>
            </div>
