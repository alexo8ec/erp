            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a class="btn btn-primary btn-xs" id="btnagregarUsuario">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="tablaUsuarios" class="table table-striped table-bordered table-hover dataTables-example tablaDatos" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
...
<div class="modal inmodal fade" id="myModalEmpresas" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title"><i class="fa-brands fa-slideshare"></i> Definir Empresas</h4>
            </div>
            <div class="modal-body">
                <div class="wrapper wrapper-content animated fadeInRight">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="frm_empresas">
                                <div class="tab-content">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="font-normal">Empresas</label>
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa-regular fa-ballot-check"></i></span>
                                                    <select class="form-control select2_demo_1" id="id_empresas_usuario" name="id_empresas_usuario[]" multiple>
                                                        <option value="">--Seleccionar--</option>
                                                        <?php
                                                        if (config('data.empresas') != '' && count(config('data.empresas'))) {
                                                            $empresas = config('data.usuario')->id_empresas_usuario;
                                                            foreach (config('data.empresas') as $row) {
                                                                $select = '';
                                                                $clave = array_search($row->id_empresa, json_decode($empresas));
                                                                if ($clave != '')
                                                                    $select = 'selected';
                                                                echo '<option value="' . $row->id_empresa . '" ' . $select . '>' . $row->razon_social_empresa . '</option>';
                                                            }
                                                        }
                                                        ?>
                                                    </select>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnguardarempresasUsuario"><i class="fa fa-save"></i> Guardar</button>
            </div>
        </div>
    </div>
</div>