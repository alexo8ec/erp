            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <label style="margin: 0px;cursor: pointer;" title="Archivo xml" for="docXML" class="ladda-button ladda-button-demo-ruc btn btn-primary btn-xs" data-style="zoom-in">
                            <input type="file" name="docXML" id="docXML" style="display:none">
                            <i class="fa fa-file-code"></i> XML
                        </label>
                        <a class="btn btn-primary btn-xs" id="btnagregarCompra">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="tablaCompras" class="table table-striped table-bordered table-hover dataTables-example tablaDatos" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>{{trans('tabla.proveedor')}}</th>
                                    <th>{{trans('tabla.fecha')}}</th>
                                    <th>{{trans('tabla.numdocumento')}}</th>
                                    <th>{{trans('tabla.tipodocumento')}}</th>
                                    <th>{{trans('tabla.valor')}} 0%</th>
                                    <th>{{trans('tabla.valor')}} 12%</th>
                                    <th>{{trans('tabla.descuento')}}</th>
                                    <th>{{trans('tabla.iva')}}</th>
                                                        ...
                                                        <div class="ibox ">
                                                            <div class="ibox-content">
                                                                <div class="form-group" id="data_1">
                                                                    ...
                                                                    <div class="input-group date">
                                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="fecha_inicio_empresa" name="fecha_inicio_empresa" class="form-control" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
...
<div class="modal inmodal fade" id="myModalXml" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                                ...
                                                <div class="ibox ">
                                                    <div class="ibox-content">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date">
                                                                <input type="date" id="fecha_emision_compra_cebacera" name="fecha_emision_compra_cebacera" class="form-control" value="2023-04-15">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
